...
public final class InParkingMultiDisruptor {
	...
	private static InParkingMultiDisruptor instance;
	public static synchronized InParkingMultiDisruptor getInstance() {
		if (instance == null) {
			synchronized (InParkingMultiDisruptor.class) {
				if (instance == null) {
					instance = new InParkingMultiDisruptor();
				}
			}
		}
		return instance;
