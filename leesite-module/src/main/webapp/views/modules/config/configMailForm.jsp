						...
						<div class="portlet-body">
							<form:form id="inputForm" modelAttribute="configMail" method="post" class="form-horizontal">
								...
								<table class="table table-striped table-bordered table-hover">
									<tbody>
									<tr>
										<td class="active" style="width: 10%;"><label class="pull-right"><span style="color: #E7505A;"> * </span>主机名：</label></td>
										<td colspan="3">
											<form:input path="mailHost" htmlEscape="false" maxlength="100" class="form-control required"/>
										</td>
									</tr>
									<tr>
										<td class="active"><label class="pull-right"><span style="color: #E7505A;"> * </span>主机端口：</label></td>
										<td colspan="3">
											<form:input path="mailPort" htmlEscape="false" maxlength="11" class="form-control required digits"/>
										</td>
									</tr>
									<tr>
										<td class="active"><label class="pull-right"><span style="color: #E7505A;"> * </span>邮箱地址：</label></td>
										<td colspan="3">
											<form:input path="mailUsername" htmlEscape="false" maxlength="100" class="form-control required"/>
										</td>
									</tr>
									<tr>
										<td class="active"><label class="pull-right"><span style="color: #E7505A;"> * </span>邮箱密码：</label></td>
										<td colspan="3">
											<form:input type="password" path="mailPassword" htmlEscape="false" maxlength="100" class="form-control required"/>
										</td>
									</tr>
									<tr>
										<td class="active"><label class="pull-right"><span style="color: #E7505A;"> * </span>发件人昵称：</label></td>
										<td colspan="3">
											<form:input path="mailFrom" htmlEscape="false" maxlength="100" class="form-control required"/>
										</td>
									</tr>
									<tr>
										<td class="active"><label class="pull-right"><span style="color: #E7505A;"> * </span>使用SSL/TLS：</label></td>
										<td colspan="3">
