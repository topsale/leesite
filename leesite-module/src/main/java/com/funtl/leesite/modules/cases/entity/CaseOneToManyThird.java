 ...
 * @version 2017-05-05
 */
public class CaseOneToManyThird extends DataEntity<CaseOneToManyThird> {
	...
	public CaseOneToManyThird() {
		super();
	}

	public CaseOneToManyThird(String id){
		super(id);
	}

	public CaseOneToManyThird(CaseOneToManyMain caseOneToManyMain){
