 ...
 * @version 2017-05-05
 */
public class CaseOneToManySecond extends DataEntity<CaseOneToManySecond> {
	...
	public CaseOneToManySecond() {
		super();
	}

	public CaseOneToManySecond(String id){
		super(id);
	}

	public CaseOneToManySecond(CaseOneToManyMain caseOneToManyMain){
