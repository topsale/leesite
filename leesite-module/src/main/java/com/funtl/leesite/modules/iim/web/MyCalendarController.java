...
import com.funtl.leesite.modules.iim.service.MyCalendarService;
import com.funtl.leesite.modules.iim.utils.DateUtil;
...
public class MyCalendarController extends BaseController {
	...
	public String addform(MyCalendar myCalendar, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	public String del(MyCalendar myCalendar, RedirectAttributes redirectAttributes) {
