...
import com.funtl.leesite.common.utils.Exceptions;
...
public class LogUtils {
	...
	public static String getMenuNamePath(String requestUri, String permission) {
		...
		@SuppressWarnings("unchecked") Map<String, String> menuMap = (Map<String, String>) CacheUtils.get(CACHE_MENU_NAME_PATH_MAP);
		if (menuMap == null) {
