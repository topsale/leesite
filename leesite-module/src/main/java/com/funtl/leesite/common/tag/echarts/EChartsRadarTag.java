...
public class EChartsRadarTag extends BodyTagSupport {
	...
	public int doEndTag() throws JspException {
		...
		if (polarType == 8) {
			polar.indicator(new Data().text("正北（N）").max(100)).indicator(new Data().text("西北（NW）").max(100)).indicator(new Data().text("正西（W）").max(100)).indicator(new Data().text("西南（SW）").max(100)).indicator(new Data().text("正南（S）").max(100)).indicator(new Data().text("东南（SE）").max(100)).indicator(new Data().text("正东（E）").max(100)).indicator(new Data().text("东北（NE)").max(100));

		} else if (polarType == 16) {
			polar.indicator(new Data().text("正北（N）").max(100)).indicator(new Data().text("北西北（NNW）").max(100)).indicator(new Data().text("西北（NW）").max(100)).indicator(new Data().text("西北西（WNW）").max(100)).indicator(new Data().text("正西（W）").max(100)).indicator(new Data().text("西南西（WSW）").max(100)).indicator(new Data().text("西南（SW）").max(100)).indicator(new Data().text("南西南（SSW）").max(100)).indicator(new Data().text("正南（S）").max(100)).indicator(new Data().text("南东南（SSE）").max(100)).indicator(new Data().text("东南（SE）").max(100)).indicator(new Data().text("东南东（ESE）").max(100)).indicator(new Data().text("正东（E）").max(100)).indicator(new Data().text("东北东（ENE）").max(100)).indicator(new Data().text("东北（NE)").max(100)).indicator(new Data().text("北东北（NNE）").max(100));
		}
		option.polar(polar);
