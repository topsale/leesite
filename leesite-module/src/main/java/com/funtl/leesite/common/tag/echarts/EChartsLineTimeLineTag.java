...
public class EChartsLineTimeLineTag extends BodyTagSupport {
	...
	public int doEndTag() throws JspException {
		 ...
		 */
		option.timeline().autoPlay(true).playInterval(1000).label().formatter("function(s){return s.slice(0, 4);}");
		 ...
		 */
		// 工具栏
		options.toolbox().orient(Orient.vertical).x(X.right).y(Y.center).show(true).feature(
				// Tool.mark,
				// Tool.dataView,
				Tool.saveAsImage,
	...
	public void setTimelineAxisData(List<Map<String, List<Double>>> timelineAxisData) {
